...
const Login = () => {
  ...
  const registeredUser = useSelector((state) => state.user.currentUser);
  ...
  return (
    ...
    <h2 style={{ marginBottom: '10px', padding: '5px', textAlign: 'center', backgroundColor: '#00BFFF', color: 'white' }}>Login Page</h2>
    <input
    ...
    <button
      style={{ backgroundColor: '#00BFFF', color: 'white', padding: '10px', border: 'none', width: '100%', borderRadius: '5px' }}
      onClick={handleLogin}
    >
      Login
    </button>
